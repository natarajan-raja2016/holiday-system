...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleMissingParams(MissingServletRequestParameterException ex, HttpServletRequest request) {
        return new ResponseEntity<>("Required parameter '" + ex.getParameterName() +"' is not present.", HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ApiErrorResponse> handleMandatoryFieldException(MandatoryFieldException ex, HttpServletRequest request) {
